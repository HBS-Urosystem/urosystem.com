...
export const sample = !browser || !typeof localStorage.sample ? writable(false) : writable(JSON.parse(browser && localStorage.sample || 'false'))
sample.subscribe((value) => browser && (localStorage.setItem(`sample`, JSON.stringify(value))))
